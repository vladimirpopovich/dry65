  ...
  <div class="wrap" style="padding-top:clamp(24px,3vw,48px);padding-bottom:clamp(40px,6vw,72px);">
    <div style="display:grid;grid-template-columns:1.05fr 0.95fr;gap:clamp(28px,4vw,56px);align-items:center;" class="hero-grid">
      ...
      <div class="reveal">
        ...
        <h1 class="display caps" style="font-size:clamp(38px,5.5vw,76px);margin-top:0;line-height:1.02;letter-spacing:0.005em;color:var(--ink);font-weight:300;white-space:nowrap;">
          Samo dođeš
        </h1>
      ...
      <div class="reveal" style="position:relative;">
        <div style="border-radius:1000px;overflow:hidden;aspect-ratio:4/5;">
          <img src="<?php echo $tpl; ?>/assets/salon/s06.webp" alt="Dry65 walk-in salon na Novom Beogradu — feniranje bez zakazivanja" loading="eager"
      ...
      <div class="reviews-slider" id="reviews-slider">
        ...
        <article class="rs-card">
          ...
          <div class="rs-foot">
            ...
            <span class="rs-google" aria-label="Google review">
              <svg width="20" height="20" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.99.69-2.26 1.1-3.71 1.1-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.69-.35-1.43-.35-2.09s.13-1.4.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
            </span>
          </div>
        </article>
        <?php endforeach; ?>
