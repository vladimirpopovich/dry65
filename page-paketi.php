...
<section class="bg-paper2 section-sm" style="padding-top:clamp(24px,3vw,40px);padding-bottom:clamp(20px,2.5vw,32px);">
  <div class="wrap">
    <span class="script" style="font-size:clamp(28px,3.6vw,44px);display:block;margin-bottom:4px;"><?php echo t('Mesečni paketi'); ?></span>
    <h1 class="display caps" style="font-size:clamp(30px,4.2vw,52px);margin-top:4px;max-width:28ch;line-height:1.0;letter-spacing:0.01em;">
      <?php echo t('Mesečni paketi feniranja u Dry65'); ?>
    </h1>
    <p class="lead" style="margin-top:26px;max-width:680px;">
      <?php echo t('Članstvo za klijentkinje kojima je feniranje deo nedeljne rutine. Mogućnost izbora između 4, 8 ili 12 feniranja mesečno, sa ili bez zakazivanja uz članstvo. Cena prati dužinu kose. Uz svaki paket sledi masaža glave i profesionalni tretman nege kose.'); ?>
    </p>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="pkg-desktop">
      ...
      <div class="center" style="margin:clamp(36px,4.5vw,56px) auto clamp(24px,3vw,36px);">
        <div class="mono" style="color:var(--clay);margin-bottom:14px;font-size:12px;letter-spacing:0.1em;text-transform:uppercase;"><?php echo t('Izaberi dužinu kose'); ?></div>
      ...
      <div class="grid cols-3">
        ...
        <div style="display:flex;flex-direction:column;">
          <div style="display:flex;align-items:baseline;gap:8px;">
            <span style="font-size:14px;color:var(--muted);"><?php echo t('od'); ?></span>
    ...
    <div class="pkg-mobile" id="pkg-mobile">
      ...
      <div class="pkg-mobile-sticky">
        <div class="mono" style="color:var(--clay);margin-bottom:10px;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;text-align:center;"><?php echo t('Izaberi dužinu kose'); ?></div>
    ...
    <div class="center" style="margin-top:clamp(40px,5vw,64px);max-width:640px;margin-inline:auto;">
      <p class="muted" style="font-size:15px;">
        <?php echo t('Paketi se kupuju u salonu. Profesionalni tretmani dubinske nege, vredni i do 6.000 dinara, uključeni su u svako članstvo. Zdrava kosa drži feniranje duže.'); ?>
      </p>
...
<?php dry65_render_faq_section('paketi', t('Sve o mesečnim paketima'), t('Odgovori na pitanja o mesečnim paketima, uštedi i uslovima korišćenja.')); ?>
