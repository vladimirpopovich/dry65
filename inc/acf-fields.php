...
add_action('acf/init', function() {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'field_svc_en_tab', 'label' => '🇬🇧 English', 'type' => 'tab'],
            ['key' => 'field_svc_title_en',   'label' => 'Title (EN)',       'name' => 'title_en',   'type' => 'text',     'instructions' => 'Engleski naslov usluge. Prazno = prikazuje se srpski.'],
            ['key' => 'field_svc_kicker_en',  'label' => 'Kicker (EN)',      'name' => 'kicker_en',  'type' => 'text'],
            ['key' => 'field_svc_short_en',   'label' => 'Short description (EN)', 'name' => 'short_en', 'type' => 'textarea', 'rows' => 2],
            ['key' => 'field_svc_body_en',    'label' => 'Full description (EN)',  'name' => 'body_en',  'type' => 'textarea', 'rows' => 5],
            ['key' => 'field_svc_content_en', 'label' => 'Content / hub (EN)', 'name' => 'content_en', 'type' => 'wysiwyg', 'instructions' => 'Engleska verzija sadržaja (za hub kategorije i članke koji koriste editor). Prazno = srpski.'],
            ['key' => 'field_svc_p1_en',      'label' => 'Item 1 (EN)',      'name' => 'point_1_en', 'type' => 'text'],
            ['key' => 'field_svc_p2_en',      'label' => 'Item 2 (EN)',      'name' => 'point_2_en', 'type' => 'text'],
            ['key' => 'field_svc_p3_en',      'label' => 'Item 3 (EN)',      'name' => 'point_3_en', 'type' => 'text'],
            ['key' => 'field_svc_gal_tab', 'label' => 'Galerija', 'type' => 'tab'],
            ['key' => 'field_svc_g1', 'label' => 'Galerija — slika 1', 'name' => 'galerija_1', 'type' => 'image', 'return_format' => 'id', 'instructions' => 'Fotke koje se prikazuju u galeriji na vrhu strane.'],
            ['key' => 'field_svc_g2', 'label' => 'Galerija — slika 2', 'name' => 'galerija_2', 'type' => 'image', 'return_format' => 'id'],
            ['key' => 'field_svc_g3', 'label' => 'Galerija — slika 3', 'name' => 'galerija_3', 'type' => 'image', 'return_format' => 'id'],
            ['key' => 'field_svc_g4', 'label' => 'Galerija — slika 4', 'name' => 'galerija_4', 'type' => 'image', 'return_format' => 'id'],
            ['key' => 'field_svc_g5', 'label' => 'Galerija — slika 5', 'name' => 'galerija_5', 'type' => 'image', 'return_format' => 'id'],
            ['key' => 'field_svc_g6', 'label' => 'Galerija — slika 6', 'name' => 'galerija_6', 'type' => 'image', 'return_format' => 'id'],
        ],
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            /* ---- Engleski prevod ---- */
            ['key' => 'field_pkg_en_tab',   'label' => '🇬🇧 English', 'type' => 'tab'],
            ['key' => 'field_pkg_cadence_en','label' => 'Cadence (EN)', 'name' => 'cadence_en', 'type' => 'text', 'instructions' => 'npr. 4 treatments per month'],
            ['key' => 'field_pkg_blurb_en',  'label' => 'Short description (EN)', 'name' => 'blurb_en', 'type' => 'textarea', 'rows' => 2],
            ['key' => 'field_pkg_gift_en',   'label' => 'Gift (EN)', 'name' => 'gift_en', 'type' => 'text'],
        ],
